...
.controller('ProjectCtrl', ['$resource', '$location', function($resource, $location) {
  var self = this;
  var Project = $resource('/projects/:projectId');
  var Scenes = $resource('/scenes/:sceneId');
  var ProjectScenes = $resource('https://localhost:3000/projects/:projectId/scenes');
  ...
  /**
   * Function to update the Project state of a selected scene
   * */
  // ProjectScenes.query({projectId: projectId}).$promise.then(function(status) {
  //
  // })


  /**
   * JS code for demo, needs to be worked upon
   * TODO: Update the code to work for our situation
   * */
